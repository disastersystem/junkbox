...
class Database
{
	...
	{
		try {
			$this->pdo = new PDO("mysql:host=127.0.0.1;dbname=susannlundekvam2","root","");
			//$this->pdo = new PDO("mysql:host=susannlundekvam2.mysql.domeneshop.no;dbname=susannlundekvam2", "susannlundekvam2", "7zBiYeBmXXdLXEi");
	 ...
	 * as an array of objects into the results property.
	 *
